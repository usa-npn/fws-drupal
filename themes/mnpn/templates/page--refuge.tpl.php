			...
			<div class="container-12">
				<div class="grid-12" style="border-top:10px solid #<?php echo $dark_color; ?>">
					<div id="main" class="main-refuge clearfix">
						...
						<!-- Page content -->
						<div id="content" style="background-color:#<?php echo $light_color; ?>" class="content content-main <?php if ( ( $page['sidebar_first'] ) && ( $page['sidebar_second'] ) ) : print 'grid-4'; elseif ( $page['sidebar_first'] ) : print 'grid-8 omega'; elseif ( $page['sidebar_second'] ) : print 'grid-8 alpha'; endif; ?>">
